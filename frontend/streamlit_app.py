"""Streamlit UI for Phase 1 - Multimodal Document Intelligence System.
...
st.caption(
    "Phase 1 · Text PDF (text + tables) · BGE-small · ChromaDB · Gemini 2.5 Flash"
)
